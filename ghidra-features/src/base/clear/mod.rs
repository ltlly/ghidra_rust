...
//! command logic ([`cmd`], [`flow_cmd`]), and action dispatching
//! ([`plugin`]). GUI-specific code (dialogs) is not ported; instead,
//! the plugin provides methods that create command objects suitable
//! for execution by any frontend.
