...
//! It handles field layout, formatting, and rendering.
//!
//! # Architecture
//!
//! ```text
...
//!
//! ```
//! use ghidra_features::base::plugin::listing::listing_plugin::ListingPlugin;
//!
...
/// field layout, formatting, and rendering rules.
///
