...
pub use query::protocol::{
    ...
    FilterAtomEntry, FilterType, FunctionEntryData, FunctionStagingManager,
    InsertOptionalValues, InsertRequestData, NullStaging, PairInputData,
    PairNoteData, PasswordChangeRequest, PreFilter, QueryChildren,
    QueryCluster, QueryDelete, QueryInfo, QueryInfoData, QueryName,
    QueryNearest, QueryPair, QueryResponseRecord, ResponseNearest,
    SimilarityNoteData, SimilarityResultRecord, StagingManager,
    VectorResultData,
};
pub use gui::results::{
