...
// ============================================================================
// Re-exports from dedicated modules (Schema, Field, DBRecord, Table)
// ============================================================================
//
// These types have been extracted to their own files:
//   - Field, Schema  -> schema.rs
//   - DBRecord       -> db_record.rs
//   - Table          -> table.rs
//   - DBHandle, PooledConnection -> db_handle.rs
//
// They are re-exported here so existing `use crate::database::db::*` imports
// continue to compile without changes.

pub use super::schema::{Field, Schema};
pub use super::db_record::DBRecord;
...
// ============================================================================
// Re-exports from db_handle module
// ============================================================================
//
// DBHandle and PooledConnection have been extracted to db_handle.rs.
// They are re-exported here for backward compatibility.

pub use super::db_handle::{DBHandle, PooledConnection};
...
pub(crate) fn execute_values(conn: &SqliteConnection, sql: &str, values: &[FieldValue]) -> SqlResult<usize> {
    if values.is_empty() {
        conn.execute(sql, [])
    } else {
...
pub(crate) fn params_to_slice(values: &[FieldValue]) -> Vec<&dyn rusqlite::types::ToSql> {
